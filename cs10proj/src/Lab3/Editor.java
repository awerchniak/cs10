...
public class Editor extends JApplet {
  ...
  private class RectButtonListener implements ActionListener {
    public void actionPerformed(ActionEvent event) {
      cmd = new DrawRect();		//set cmd to a DrawRect object, garbage collection will delete old
      repaint();
    }
  }
  ...
  private class EllipseButtonListener implements ActionListener {
    public void actionPerformed(ActionEvent event) {
      cmd = new DrawEllipse();		//set cmd to a DrawEllipse object, garbage collection will delete old
      repaint();
    }
  }
  ...
  private class LineButtonListener implements ActionListener {
    public void actionPerformed(ActionEvent event) {
      cmd = new DrawLine();		//set cmd to a DrawLine object, garbage collection will delete old
      repaint();
    }
  }
  ...
  private class MoveButtonListener implements ActionListener {
    public void actionPerformed(ActionEvent event) {
      cmd = new MoveShape();		//set cmd to a MoveShape object, garbage collection will delete old
      repaint();
    }
  }
  ...
  private class DeleteButtonListener implements ActionListener {
    public void actionPerformed(ActionEvent event) {
      cmd = new DeleteCmd();	//set cmd to a DeleteCmd object, garbage collection will delete old
      repaint();
    }
  }
  ...
  private class FrontButtonListener implements ActionListener {
    public void actionPerformed(ActionEvent event) {
      cmd = new FrontCmd();		//set cmd to a FrontCmd object, garbage collection will delete old
      repaint();
    }
  }
  ...
  private class BackButtonListener implements ActionListener {
    public void actionPerformed(ActionEvent event) {
      cmd = new BackCmd();		 //set cmd to a BackCmd object, garbage collection will delete old
      repaint();
    }
  }
  ...
  private class ExchangeButtonListener implements ActionListener {
    public void actionPerformed(ActionEvent event) {
      cmd = new ExchangeCmd();	//set cmd to an ExchangeCmd object, garbage collection will delete old
      repaint();
    }
  }
  ...
  private class RedButtonListener implements ActionListener {
    public void actionPerformed(ActionEvent event) {
      cmd = new RedCmd();							//set cmd to a RedCmd object, garbage collection will delete old
      dwg.setColor(Color.RED);				//set the color of the drawing to red so the next shape is red
      colorBox.show(dwg.getColor());	//change the colorbox
      repaint();
    }
  }
  ...
  private class GreenButtonListener implements ActionListener {
    public void actionPerformed(ActionEvent event) {
      cmd = new GreenCmd();						//set cmd to a GreenCmd object, garbage collection will delete old
      dwg.setColor(Color.GREEN);			//set color of drawing to green so the next shape is green
      colorBox.show(dwg.getColor());	//change the colorbox display
      repaint();
    }
  }
  ...
  private class BlueButtonListener implements ActionListener {
    public void actionPerformed(ActionEvent event) {
      cmd = new BlueCmd();						//set cmd to a BlueCmd object, garbage collection will delete old
      dwg.setColor(Color.BLUE);				//set color of drawing to blue so the next shape is blue
      colorBox.show(dwg.getColor());	//change the colorbox display
      repaint();
    }
  }
