...
public class SentinelDLL<T> implements CS10LinkedList<T> {
  ...
  public void append(SentinelDLL<T> other){
  	...
  	//last of this points to first of other
  	this.sentinel.previous.next = other.sentinel.next;
  	//first of other points to last of this
  	other.sentinel.next.previous = this.sentinel.previous;
  	//last of other points to this.sentinel
  	other.sentinel.previous.next = this.sentinel;
  	//this.sentinel points to last of other
  	this.sentinel.previous = other.sentinel.previous;
  	
  	//clear the other list so there is only one list
  	other.clear();
  }
